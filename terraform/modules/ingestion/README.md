...
| <a name="input_name"></a> [name](#input\_name) | Name prefix for ingestion resources | `string` | n/a | yes |
| <a name="input_opensearch_endpoint"></a> [opensearch\_endpoint](#input\_opensearch\_endpoint) | OpenSearch domain endpoint | `string` | n/a | yes |
| <a name="input_opensearch_index"></a> [opensearch\_index](#input\_opensearch\_index) | OpenSearch index name for STAC items | `string` | `"stac"` | no |
